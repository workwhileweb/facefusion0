"""
Single Gradio layout with inner tabs (default | webcam). Using two top-level
layouts (default + webcam) duplicates every component and .listen() twice,
which breaks Gradio's queue (e.g. KeyError: fn_index).
"""
import gradio
